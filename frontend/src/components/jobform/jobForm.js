                ...
                <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-gray-200 sm:pt-5">
                  ...
                  <div className="mt-1 sm:mt-0 sm:col-span-2">
                    ...
                    <p className="mt-2 text-sm max-w-md text-gray-500">
                      Will only get the text of an element that matches the
                      given CSS selector. Also accepts CSS paths. If no element
                      is found, all text on the page will be selected.
                    </p>
                  </div>
                </div>
                <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-gray-200 sm:pt-5">
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                          ...
                          <div className="mt-1 sm:mt-0 sm:col-span-2">
                            ...
                            <p className="mt-2 text-sm text-gray-500 max-w-lg">
                              Scrolls to the DOM element that matches the given
